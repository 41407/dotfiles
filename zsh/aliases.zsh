...
alias gsh='git show'
alias gshw='git show'
alias gshf='git show -s --format=%B'
...
alias gchb='git nb' # same as above
alias gcob='git nb' # same as above
alias grs='git reset'
...
alias unitylogless='cat ~/Library/Logs/Unity/Editor.log | grep -e "^\[[A-Za-z]" |less'
